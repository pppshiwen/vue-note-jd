	...
	<div class="m_r">
		...
		<main class="user_login_box">
		    <div class="login_dialog">
				...
				<input type="hidden" name="reguser_pic" v-model="reguser_pic">
		        <div class="login_box">
	...
	export default{
		data(){
			return{
				...
				regpasswd:'',
				regpasswd_ag:'',
				reguser_pic:"https://p1.ssl.qhmsg.com/dr/270_500_/t012a23393af202c19e.jpg",
				regInfo:{}
			}
		},
		methods:{
